...
public class CreateAccount {
	...
	public static void main(String[] args) {
        ...
        //Enter AccountName
        driver.findElement(By.xpath("//input[@id='accountName']")).sendKeys("Prathiba");
        //Enter description
        ...
        WebElement source2 = driver.findElement(By.xpath("//select[@id='marketingCampaignId']"));
        ...
        WebElement source3 = driver.findElement(By.xpath("//select[@id='generalCountryGeoId']"));
        Select dropdown4 = new Select(source3);
        dropdown4.selectByVisibleText("United States");
        WebElement source4 = driver.findElement(By.xpath("//select[@id='generalStateProvinceGeoId']"));
