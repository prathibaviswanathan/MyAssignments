...
public class EditLead {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@id='createLeadForm_companyName']")).sendKeys("ACN");
        //Enter firstName using Attribute based Xpath
        driver.findElement(By.xpath("//input[@id='createLeadForm_firstName']")).sendKeys("Prathiba");
        ...
        driver.findElement(By.xpath("//input[@id='createLeadForm_firstNameLocal']")).sendKeys("rec");
        //Enter department field using any locator
        driver.findElement(By.id("createLeadForm_departmentName")).sendKeys("IT");
        //Enter Description field using any locator
        driver.findElement(By.id("createLeadForm_description")).sendKeys("IT Services");
